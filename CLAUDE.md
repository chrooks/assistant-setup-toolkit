...
`.claude/` is the **Canonical Assistant Source** — the single source of truth for all assistant configuration (instructions, skills, hooks, commands). `.codex/` and `.agents/` are **Target Projections** — generated views for Codex CLI that are gitignored and regenerated by the Setup Wizard. Always edit `.claude/` first; projections follow automatically.
...
| Directory | Purpose |
|-----------|---------|
| `.claude/` | Canonical Assistant Source (instructions, skills, hooks, commands) |
| `.claude/skills/` | Project-scoped skills (`/commit`, `/feature`, `/handoff`, `/mode`, `/ingest-skill`) |
